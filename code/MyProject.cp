#line 1 "C:/Users/karim/Downloads/MikroC/Training/MyProject.c"
#line 14 "C:/Users/karim/Downloads/MikroC/Training/MyProject.c"
short int counter = 1;
int i,j;
 ...
 while(1)
{
 ...
 while( portb.B1 !=1){if(counter%2 == 1) return;};
 for(i=0;i<3;i++)
 { if(counter%2 == 1) return;
  portd.B7  = 1;
 portc = arr[i];
