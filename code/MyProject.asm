...
;MyProject.c,22 :: 		if(counter == 10){counter = -1;}
	MOVF       _counter+0, 0
	XORLW      10
	BTFSS      STATUS+0, 2
	GOTO       L_interrupt1
...
L__automatic54:
	BTFSC      STATUS+0, 0
	GOTO       L_automatic9
;MyProject.c,41 :: 		if(counter%2 == 0) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
L__automatic57:
	BTFSC      STATUS+0, 0
	GOTO       L_automatic14
;MyProject.c,48 :: 		if(counter%2 == 0) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
L__automatic58:
	BTFSC      STATUS+0, 0
	GOTO       L_automatic19
;MyProject.c,55 :: 		if(counter%2 == 0) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
L__automatic63:
	BTFSC      STATUS+0, 0
	GOTO       L_automatic24
;MyProject.c,63 :: 		if(counter%2 == 0) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
L__manual67:
	BTFSC      STATUS+0, 0
	GOTO       L_manual31
;MyProject.c,74 :: 		{     if(counter%2 == 1) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
;MyProject.c,80 :: 		yel1 = 0;red1 =1;
	BCF        PORTD+0, 1
	BSF        PORTD+0, 2
;MyProject.c,81 :: 		while(manmode!=1){if(counter%2 == 1) return;};
L_manual35:
	BTFSC      PORTB+0, 1
	GOTO       L_manual36
	MOVLW      2
...
L__manual72:
	BTFSC      STATUS+0, 0
	GOTO       L_manual39
;MyProject.c,83 :: 		{    if(counter%2 == 1) return;
	MOVLW      2
	MOVWF      R4+0
	MOVF       _counter+0, 0
	MOVWF      R0+0
...
;MyProject.c,89 :: 		yel2 = 0;red2 = 1;
	BCF        PORTD+0, 5
	BSF        PORTD+0, 6
;MyProject.c,90 :: 		while(manmode!=1){if(counter%2 == 1) return;};
L_manual43:
	BTFSC      PORTB+0, 1
	GOTO       L_manual44
	MOVLW      2
